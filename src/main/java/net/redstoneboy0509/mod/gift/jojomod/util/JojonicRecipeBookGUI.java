...
public class JojonicRecipeBookGUI extends RecipeBookGui {
    ...
    protected final JojonicRecipeBookPage recipeBookPage = new JojonicRecipeBookPage();
    ...
    public void initSearchBar(boolean widthTooNarrowIn) {
        ...
        this.recipeTabs.add(new RecipeTabToggleWidget(RecipeBookCategories.SEARCH));
    ...
    private void updateCollections(boolean p_193003_1_) {
        ...
        for(IRecipe<?> r : JojonicSigilTableTileEntity.findRecipesByType(ModRecipes.JOJONIC_CRAFTING_TYPE)) {
            recipeList.add(r);
        }
        List<RecipeList> list = Collections.singletonList(recipeList);
