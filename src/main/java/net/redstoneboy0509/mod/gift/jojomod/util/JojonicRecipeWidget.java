...
public class JojonicRecipeWidget extends Widget {
    ...
    public JojonicRecipeWidget() {
        super(0, 0, 25, 25, "");
    }

    public void func_203400_a(RecipeList p_203400_1_, JojonicRecipeBookPage p_203400_2_) {
