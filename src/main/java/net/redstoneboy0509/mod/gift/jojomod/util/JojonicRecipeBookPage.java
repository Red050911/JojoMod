...
public class JojonicRecipeBookPage {

    private final List<JojonicRecipeWidget> buttons = Lists.newArrayListWithCapacity(20);
    private JojonicRecipeWidget hoveredButton;
    ...
    public JojonicRecipeBookPage() {
        for(int i = 0; i < 20; ++i) {
            this.buttons.add(new JojonicRecipeWidget());
        }
    ...
    public void init(Minecraft p_194194_1_, int p_194194_2_, int p_194194_3_) {
        ...
        this.forwardButton.initTextureValues(1, 208, 13, 18, JojonicRecipeBookGUI.RECIPE_BOOK);
        this.backButton = new ToggleWidget(p_194194_2_ + 38, p_194194_3_ + 137, 12, 17, true);
        this.backButton.initTextureValues(1, 208, 13, 18, JojonicRecipeBookGUI.RECIPE_BOOK);
    }

    public void addListener(JojonicRecipeBookGUI p_193732_1_) {
    ...
    private void updateButtonsForPage() {
        ...
        for(int j = 0; j < this.buttons.size(); ++j) {
            JojonicRecipeWidget recipewidget = this.buttons.get(j);
    ...
    public void render(int x, int y, int mouseX, int mouseY, float partialTicks) {
        ...
        for(JojonicRecipeWidget recipewidget : this.buttons) {
