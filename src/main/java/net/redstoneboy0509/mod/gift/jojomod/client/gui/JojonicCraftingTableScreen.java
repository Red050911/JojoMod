...
import net.redstoneboy0509.mod.gift.jojomod.util.JojonicRecipeBookGUI;

public class JojonicCraftingTableScreen extends ContainerScreen<JojoCraftingTableContainer> implements IRecipeShownListener {

    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation("textures/gui/container/crafting_table.png");
    private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation("textures/gui/recipe_button.png");
    private final JojonicRecipeBookGUI recipeBookGui = new JojonicRecipeBookGUI();
    private boolean widthTooNarrow;

    public JojonicCraftingTableScreen(JojoCraftingTableContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
